...
import AICoder from './src/ai-coder.js';
...
app.post('/api/generate', async (req, res) => {
  try {
    ...
    const result = await aiCoder.generateWebsite({
      name,
      type,
      description,
      pages,
...
app.get('/api/website/:id', (req, res) => {
  try {
    const website = aiCoder.getWebsite(req.params.id);
    if (!website) {
...
app.get('/api/websites', (req, res) => {
  try {
    const websites = aiCoder.getAllWebsites();
...
app.get('/api/templates', (req, res) => {
  const templates = aiCoder.getTemplates();
...
app.get('/api/themes', (req, res) => {
  const themes = aiCoder.getThemes();
...
app.get('/api/features', (req, res) => {
  const features = aiCoder.getFeatures();
...
app.get('/api/download/:id', (req, res) => {
  try {
    ...
    const zipContent = aiCoder.generateZipContent(website);
